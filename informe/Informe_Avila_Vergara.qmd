...
format:
  pdf:
    ...
    include-before: |
      ...
      \centering
      \vspace*{1cm}
      \includegraphics[width=0.15\textwidth]{jalisco.jpg}\\[0.5cm]
      {\Huge\bfseries Análisis Demográfico para el Estado de Jalisco \par}
      \vspace{0.3cm}
      {\Large Modelación de Funciones de Supervivencia, Tablas de Decrementos Múltiples y Dinámicas de Fecundidad \par}
      \vspace{1.5cm}
      {\large \textbf{Viviana Montserrat Vergara Galindo} \\
      \textbf{Claudia Areli Avila Melgarejo} \par}
      \vfill
      {\large \today \par}
      \end{titlepage}
---
